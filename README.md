...
2. Distance values form the state  
3. DQN predicts best action  
4. Car performs lane change / stay  
5. Reward is given based on outcome  
...
* Integration with simulators like CARLA
